...
if(isset($_POST['submit'])){
    ...
    $news_body = htmlspecialchars($_POST['bodytext']);
        ...
        if(empty($errors)==true){
           ...
           $sql = "INSERT INTO news (headtext, newstext, picture_path) VALUES (?,?,?)";
            $stmt= $pdo->prepare($sql);
            $stmt->execute([$news_head, $news_body, $path_image]);
           header("./all_news.php");
        }else{
           print_r($errors);
        }
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h3 class="text-dark mb-4">Nieuwsbrief item toevoegen</h3>
                    <div class="container-fluid">
